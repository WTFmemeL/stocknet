#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# run_experiments_v16.py - Target adaptatif : Top 15% des mouvements
...
print("\n=== StockNet v16 – Target Adaptatif (Top 15% des mouvements) ===")
...
# === TARGET ADAPTATIF : TOP 15% DES MOUVEMENTS ===
print("\n🎯 Génération du target adaptatif (Top 15%)...")
print("   Principe : Les 15% meilleurs mouvements haussiers/baissiers")
print("   Fenêtre : 1-12 minutes")
print("   Avantage : Adaptatif à la volatilité du marché")
...
# Top 15% des mouvements haussiers = Strong Buy
# Top 15% des mouvements baissiers = Strong Sell
# Le reste = Hold

quantile_buy = max_future_move.quantile(0.85)   # 85ème percentile
quantile_sell = min_future_move.quantile(0.15)  # 15ème percentile

print(f"\n📊 Seuils adaptatifs calculés :")
print(f"   Buy threshold (top 15%) : {quantile_buy:.4%}")
print(f"   Sell threshold (bottom 15%) : {quantile_sell:.4%}")
...
def StockNetV16(input_shape):
    """
    Architecture optimisée pour apprendre des patterns relatifs
    """
...
model = StockNetV16((100, len(features)))
print("\n🧠 Architecture du modèle :")
model.summary()

print("\n⚙️ Entraînement StockNet v16...")
...
# --- SAUVEGARDE ---
model.save("/home/jx/Documents/stocknet/out/model_v16.keras")
print("\n💾 Modèle sauvegardé : model_v16.keras")
...
out_path = "/home/jx/Documents/stocknet/out/preds_v16.csv"
...
print("\n✅ v16 terminé ! Target adaptatif avec Top 15% 🎯")
print("   Distribution équilibrée garantie !")
